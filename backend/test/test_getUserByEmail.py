...
def test_valid_email_matches_zero_users_prints_warning_returns_none(user_controller, capsys):
...
@pytest.mark.getuserbyemail
def test_prints_warning_when_multiple_users_found_returns_first_user(user_controller, capsys):
